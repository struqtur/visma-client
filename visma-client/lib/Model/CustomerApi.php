...
class CustomerApi implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'email_address_order' => 'string',
        'email_address_quote' => 'string',
        ...
        'delivery_based_vat' => 'bool',
        'sales_price_list_id' => 'string',
        'iban' => 'string',
        'direct_debit_customer_settings' => '\Struqtur\VismaEAccounting\Model\DirectDebitCustomerSettingsApi',
        'discount_agreement_id' => 'string',
        'unpaid_invoices_amount' => 'double'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'gln' => null,
        'email_address' => null,
        'email_address_order' => null,
        'email_address_quote' => null,
        ...
        'delivery_based_vat' => null,
        'sales_price_list_id' => 'uuid',
        'iban' => null,
        'direct_debit_customer_settings' => null,
        'discount_agreement_id' => 'uuid',
        'unpaid_invoices_amount' => 'double'
    ];
    ...
    protected static $attributeMap = [
        ...
        'email_address_order' => 'EmailAddressOrder',
        'email_address_quote' => 'EmailAddressQuote',
        ...
        'delivery_based_vat' => 'DeliveryBasedVat',
        'sales_price_list_id' => 'SalesPriceListId',
        'iban' => 'Iban',
        'direct_debit_customer_settings' => 'DirectDebitCustomerSettings',
        'discount_agreement_id' => 'DiscountAgreementId',
    ...
    protected static $setters = [
        ...
        'email_address_order' => 'setEmailAddressOrder',
        'email_address_quote' => 'setEmailAddressQuote',
        ...
        'delivery_based_vat' => 'setDeliveryBasedVat',
        'sales_price_list_id' => 'setSalesPriceListId',
        'iban' => 'setIban',
        'direct_debit_customer_settings' => 'setDirectDebitCustomerSettings',
        'discount_agreement_id' => 'setDiscountAgreementId',
        'unpaid_invoices_amount' => 'setUnpaidInvoicesAmount'
    ];
    ...
    protected static $getters = [
        ...
        'email_address_order' => 'getEmailAddressOrder',
        'email_address_quote' => 'getEmailAddressQuote',
        ...
        'delivery_based_vat' => 'getDeliveryBasedVat',
        'sales_price_list_id' => 'getSalesPriceListId',
        'iban' => 'getIban',
        'direct_debit_customer_settings' => 'getDirectDebitCustomerSettings',
        'discount_agreement_id' => 'getDiscountAgreementId',
        'unpaid_invoices_amount' => 'getUnpaidInvoicesAmount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['email_address_order'] = isset($data['email_address_order']) ? $data['email_address_order'] : null;
        $this->container['email_address_quote'] = isset($data['email_address_quote']) ? $data['email_address_quote'] : null;
        ...
        $this->container['delivery_based_vat'] = isset($data['delivery_based_vat']) ? $data['delivery_based_vat'] : null;
        $this->container['sales_price_list_id'] = isset($data['sales_price_list_id']) ? $data['sales_price_list_id'] : null;
        $this->container['iban'] = isset($data['iban']) ? $data['iban'] : null;
        $this->container['direct_debit_customer_settings'] = isset($data['direct_debit_customer_settings']) ? $data['direct_debit_customer_settings'] : null;
        $this->container['discount_agreement_id'] = isset($data['discount_agreement_id']) ? $data['discount_agreement_id'] : null;
        $this->container['unpaid_invoices_amount'] = isset($data['unpaid_invoices_amount']) ? $data['unpaid_invoices_amount'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['email_address_order']) && (mb_strlen($this->container['email_address_order']) > 255)) {
            $invalidProperties[] = "invalid value for 'email_address_order', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['email_address_order']) && (mb_strlen($this->container['email_address_order']) < 0)) {
            $invalidProperties[] = "invalid value for 'email_address_order', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['email_address_quote']) && (mb_strlen($this->container['email_address_quote']) > 255)) {
            $invalidProperties[] = "invalid value for 'email_address_quote', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['email_address_quote']) && (mb_strlen($this->container['email_address_quote']) < 0)) {
            $invalidProperties[] = "invalid value for 'email_address_quote', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets email_address
     *
     * @param string $email_address Max length: 255 characters  This is a default email address for sending customer invoices.  If EmailAddressOrder and EmailAddressQuote properties are empty we use this email as default one for sending quotes and orders.
     *
     * @return $this
     */
    ...
    /**
     * Gets email_address_order
     *
     * @return string
     */
    public function getEmailAddressOrder()
    {
        return $this->container['email_address_order'];
    }

    /**
     * Sets email_address_order
     *
     * @param string $email_address_order Max length: 255 characters  This is a default email address for sending orders.  If it is empty then we use general EmailAddress property.
     *
     * @return $this
     */
    public function setEmailAddressOrder($email_address_order)
    {
        if (!is_null($email_address_order) && (mb_strlen($email_address_order) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email_address_order when calling CustomerApi., must be smaller than or equal to 255.');
        }
        if (!is_null($email_address_order) && (mb_strlen($email_address_order) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email_address_order when calling CustomerApi., must be bigger than or equal to 0.');
        }

        $this->container['email_address_order'] = $email_address_order;

        return $this;
    }

    /**
     * Gets email_address_quote
     *
     * @return string
     */
    public function getEmailAddressQuote()
    {
        return $this->container['email_address_quote'];
    }

    /**
     * Sets email_address_quote
     *
     * @param string $email_address_quote Max length: 255 characters  This is a default email address for sending quotes.  If it is empty then we use general EmailAddress property.
     *
     * @return $this
     */
    public function setEmailAddressQuote($email_address_quote)
    {
        if (!is_null($email_address_quote) && (mb_strlen($email_address_quote) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email_address_quote when calling CustomerApi., must be smaller than or equal to 255.');
        }
        if (!is_null($email_address_quote) && (mb_strlen($email_address_quote) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email_address_quote when calling CustomerApi., must be bigger than or equal to 0.');
        }

        $this->container['email_address_quote'] = $email_address_quote;
    ...
    /**
     * Gets delivery_based_vat
     *
     * @return bool
     */
    public function getDeliveryBasedVat()
    {
        return $this->container['delivery_based_vat'];
    }

    /**
     * Sets delivery_based_vat
     *
     * @param bool $delivery_based_vat Purpose: Option to set the delivery address as the base for vat and oss calculations. Delivery city, country code and postal code must be set aswell
     *
     * @return $this
     */
    public function setDeliveryBasedVat($delivery_based_vat)
    {
        $this->container['delivery_based_vat'] = $delivery_based_vat;
     ...
     *
     * @param string $sales_price_list_id Returns the sales price list id that is connected to the customer. It will be used only for Pro variant companies
     *
     * @return $this
     */
     ...
     * Sets iban
     *
     * @param string $iban Purpose: Customer's bank account IBAN (manual entry)
     *
     * @return $this
     */
    ...
    /**
     * Gets direct_debit_customer_settings
     *
     * @return \Struqtur\VismaEAccounting\Model\DirectDebitCustomerSettingsApi
     */
    public function getDirectDebitCustomerSettings()
    {
        return $this->container['direct_debit_customer_settings'];
    }

    /**
     * Sets direct_debit_customer_settings
     *
     * @param \Struqtur\VismaEAccounting\Model\DirectDebitCustomerSettingsApi $direct_debit_customer_settings Purpose: Direct Debit module (for the Netherlands) settings
     *
     * @return $this
     */
    public function setDirectDebitCustomerSettings($direct_debit_customer_settings)
    {
        $this->container['direct_debit_customer_settings'] = $direct_debit_customer_settings;

        return $this;
    }

    /**
     * Gets discount_agreement_id
     *
     * @return string
     */
    public function getDiscountAgreementId()
    {
        return $this->container['discount_agreement_id'];
    }

    /**
     * Sets discount_agreement_id
     *
     * @param string $discount_agreement_id Returns the discount agreement id that is connected to the customer. It will be used only for Pro variant companies
     *
     * @return $this
     */
    public function setDiscountAgreementId($discount_agreement_id)
    {
        $this->container['discount_agreement_id'] = $discount_agreement_id;

        return $this;
    }

    /**
     * Gets unpaid_invoices_amount
     *
     * @return double
     */
    public function getUnpaidInvoicesAmount()
    {
        return $this->container['unpaid_invoices_amount'];
    }

    /**
     * Sets unpaid_invoices_amount
     *
     * @param double $unpaid_invoices_amount The total amount of unpaid invoices for the customer.
     *
     * @return $this
     */
    public function setUnpaidInvoicesAmount($unpaid_invoices_amount)
    {
        $this->container['unpaid_invoices_amount'] = $unpaid_invoices_amount;
