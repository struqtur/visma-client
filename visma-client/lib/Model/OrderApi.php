...
class OrderApi implements ModelInterface, ArrayAccess
{
    ...
    public function setYourReference($your_reference)
    {
        if (!is_null($your_reference) && (mb_strlen($your_reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $your_reference when calling OrderApi., must be smaller than or equal to 100.');
        }
    ...
    public function setOurReference($our_reference)
    {
        if (!is_null($our_reference) && (mb_strlen($our_reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $our_reference when calling OrderApi., must be smaller than or equal to 100.');
        }
    ...
    public function setBuyersOrderReference($buyers_order_reference)
    {
        if (!is_null($buyers_order_reference) && (mb_strlen($buyers_order_reference) > 35)) {
            throw new \InvalidArgumentException('invalid length for $buyers_order_reference when calling OrderApi., must be smaller than or equal to 35.');
        }
        if (!is_null($buyers_order_reference) && (mb_strlen($buyers_order_reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $buyers_order_reference when calling OrderApi., must be bigger than or equal to 0.');
        }
     ...
     * Sets customer_name
     *
     * @param string $customer_name Readonly  The selected customers name
     *
     * @return $this
     */
