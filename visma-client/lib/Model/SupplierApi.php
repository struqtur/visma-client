...
class SupplierApi implements ModelInterface, ArrayAccess
{
    ...
    protected static $attributeMap = [
        ...
        'is_active' => 'IsActive',
        'proportional_vat' => 'ProportionalVat',
    ...
    protected static $setters = [
        ...
        'proportional_vat' => 'setProportionalVat',
    ...
    protected static $getters = [
        ...
        'proportional_vat' => 'getProportionalVat',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['proportional_vat'] = isset($data['proportional_vat']) ? $data['proportional_vat'] : null;
     ...
     *
     * @param double $unpaid_invoices_amount unpaid_invoices_amount
     *
     * @return $this
     */
     ...
     *
     * @param string $foreign_payment_code_id Source: Get from /v2/foreignpaymentcodes. Purpose: Used for categorization of foreign purchases (NO and SE only). Must be set if having active bankintegration, Supplier is foreign and AutomaticPaymentService is false.
     *
     * @return $this
     */
    ...
    /**
     * Gets proportional_vat
     *
     * @return bool
     */
    public function getProportionalVat()
    {
        return $this->container['proportional_vat'];
    }

    /**
     * Sets proportional_vat
     *
     * @param bool $proportional_vat Purpose: Inform that the supplier has Proportional VAT activated Default: false
     *
     * @return $this
     */
    public function setProportionalVat($proportional_vat)
    {
        $this->container['proportional_vat'] = $proportional_vat;
