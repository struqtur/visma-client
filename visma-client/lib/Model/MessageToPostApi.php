...
class MessageToPostApi implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['document_type'] > 16)) {
            $invalidProperties[] = "invalid value for 'document_type', must be smaller than or equal to 16.";
        }
    ...
    public function setDocumentType($document_type)
    {
        ...
        if (($document_type > 16)) {
            throw new \InvalidArgumentException('invalid value for $document_type when calling MessageToPostApi., must be smaller than or equal to 16.');
        }
        if (($document_type < 0)) {
