...
class ArticleApi implements ModelInterface, ArrayAccess
{
     ...
     * Sets uses_moss
     *
     * @param bool $uses_moss This property can be set to true if the moss setting is checked in company settings and the sales category for the article is Service
     *
     * @return $this
     */
     ...
     *
     * @param int $green_technology_type Type of green technology on the article, can be :   None = 0,  SolarCellInstallation = 1,  ElectricEnergyStorageInstallation = 2,  ElectricVehicleChargingPointInstallation = 3,  Default value is 0. Not setting it has the same behavior as setting it to None
     *
     * @return $this
     */
