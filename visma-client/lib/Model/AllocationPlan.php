...
class AllocationPlan implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $supplier_invoice_draft_id If assigned, SupplierInvoiceDraftRow must be set
     *
     * @return $this
     */
     ...
     *
     * @param int $supplier_invoice_draft_row Required if SupplierInvoiceDraftId is assigned
     *
     * @return $this
     */
