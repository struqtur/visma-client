...
class AttachmentResultApi implements ModelInterface, ArrayAccess
{
    ...
    const ATTACHED_DOCUMENT_TYPE_8 = 8;
    const TYPE_0 = 0;
    const TYPE_1 = 1;
    const TYPE_2 = 2;
     ...
     * Sets image_date
     *
     * @param \DateTime $image_date Date when source image was uploaded
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $transaction_date The interpreted transaction date of the source image, eg invoicedate for a invoice, paymentdate for a reciept.   Can be null if not interpreted.
     *
     * @return $this
     */
