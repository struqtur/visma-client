...
/**
 * VoucherWithOverunderPaymentApi Class Doc Comment
 *
 * @category Class
 * @package  Struqtur\VismaEAccounting
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VoucherWithOverunderPaymentApi implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VoucherWithOverunderPaymentApi';
    ...
    protected static $swaggerTypes = [
        ...
        'voucher_text' => 'string',
        'rows' => '\Struqtur\VismaEAccounting\Model\VoucherWithOverunderPaymentRowApi[]',
     ...
     * Sets voucher_text
     *
     * @param string $voucher_text Default: Default text for payment from customer or supplier
     *
     * @return $this
     */
    public function setVoucherText($voucher_text)
    {
        if (!is_null($voucher_text) && (mb_strlen($voucher_text) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $voucher_text when calling VoucherWithOverunderPaymentApi., must be smaller than or equal to 1000.');
        }
        if (!is_null($voucher_text) && (mb_strlen($voucher_text) < 0)) {
            throw new \InvalidArgumentException('invalid length for $voucher_text when calling VoucherWithOverunderPaymentApi., must be bigger than or equal to 0.');
        }
     ...
     * Gets rows
     *
     * @return \Struqtur\VismaEAccounting\Model\VoucherWithOverunderPaymentRowApi[]
     */
     ...
     * Sets rows
     *
     * @param \Struqtur\VismaEAccounting\Model\VoucherWithOverunderPaymentRowApi[] $rows rows
     *
     * @return $this
     */
