...
class CustomerInvoiceApi implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'is_sold' => 'bool',
        'factoring_invoice_status' => 'int',
        'payment_date' => '\DateTime',
        'payment_status' => 'int',
        'credited_by' => '\Struqtur\VismaEAccounting\Model\CreditedByApi[]',
    ...
    protected static $swaggerFormats = [
        ...
        'is_sold' => null,
        'factoring_invoice_status' => 'int32',
    ...
    protected static $attributeMap = [
        ...
        'is_sold' => 'IsSold',
        'factoring_invoice_status' => 'FactoringInvoiceStatus',
    ...
    protected static $setters = [
        ...
        'is_sold' => 'setIsSold',
        'factoring_invoice_status' => 'setFactoringInvoiceStatus',
        'payment_date' => 'setPaymentDate',
        'payment_status' => 'setPaymentStatus',
        'credited_by' => 'setCreditedBy',
    ...
    protected static $getters = [
        ...
        'is_sold' => 'getIsSold',
        'factoring_invoice_status' => 'getFactoringInvoiceStatus',
        'payment_date' => 'getPaymentDate',
        'payment_status' => 'getPaymentStatus',
        'credited_by' => 'getCreditedBy',
    ...
    const SEND_TYPE_2 = 2;
    const SEND_TYPE_3 = 3;
    const FACTORING_INVOICE_STATUS_0 = 0;
    const FACTORING_INVOICE_STATUS_3 = 3;
    const FACTORING_INVOICE_STATUS_4 = 4;
    const FACTORING_INVOICE_STATUS_6 = 6;
    const FACTORING_INVOICE_STATUS_7 = 7;
    const FACTORING_INVOICE_STATUS_8 = 8;
    const FACTORING_INVOICE_STATUS_9 = 9;
    const FACTORING_INVOICE_STATUS_10 = 10;
    const FACTORING_INVOICE_STATUS_11 = 11;
    const FACTORING_INVOICE_STATUS_12 = 12;
    const FACTORING_INVOICE_STATUS_13 = 13;
     ...
     * @return string[]
     */
    public function getFactoringInvoiceStatusAllowableValues()
    {
        return [
            self::FACTORING_INVOICE_STATUS_0,
            self::FACTORING_INVOICE_STATUS_3,
            self::FACTORING_INVOICE_STATUS_4,
            self::FACTORING_INVOICE_STATUS_6,
            self::FACTORING_INVOICE_STATUS_7,
            self::FACTORING_INVOICE_STATUS_8,
            self::FACTORING_INVOICE_STATUS_9,
            self::FACTORING_INVOICE_STATUS_10,
            self::FACTORING_INVOICE_STATUS_11,
            self::FACTORING_INVOICE_STATUS_12,
            self::FACTORING_INVOICE_STATUS_13,
        ];
    }
    ...
    {
        return [
            self::PAYMENT_STATUS_0,
            self::PAYMENT_STATUS_1,
            self::PAYMENT_STATUS_2,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['factoring_invoice_status'] = isset($data['factoring_invoice_status']) ? $data['factoring_invoice_status'] : null;
        $this->container['payment_date'] = isset($data['payment_date']) ? $data['payment_date'] : null;
        $this->container['payment_status'] = isset($data['payment_status']) ? $data['payment_status'] : null;
        $this->container['credited_by'] = isset($data['credited_by']) ? $data['credited_by'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getFactoringInvoiceStatusAllowableValues();
        if (!is_null($this->container['factoring_invoice_status']) && !in_array($this->container['factoring_invoice_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'factoring_invoice_status', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets eu_third_party
     *
     * @param bool $eu_third_party Default: false. True only if EU intermediary, VAT triangulation rules apply.  Only if EU company is invoicing to a company from a different EU country, may set to True if desired.
     *
     * @return $this
     */
     ...
     *
     * @param double $rot_reduced_invoicing_percent Format: 4 decimals
     *
     * @return $this
     */
     ...
     * Sets is_sold
     *
     * @param bool $is_sold Defines whether customer invoice was sold using an integration with factoring partner
     *
     * @return $this
     */
    ...
    /**
     * Gets factoring_invoice_status
     *
     * @return int
     */
    public function getFactoringInvoiceStatus()
    {
        return $this->container['factoring_invoice_status'];
    }

    /**
     * Sets factoring_invoice_status
     *
     * @param int $factoring_invoice_status Describes the sold invoice status in factoring partner system.  0 - Unknown  1 - Applied(applies for soft offers)  2 - Withdrawn(applies for soft offers)  3 - Rejected(applies for soft offers)  4 - Sold  5 - Approved(applies for soft offers)  6 - FirstReminderSent  7 - DebtCollection  8 - Reclaimed  9 - FullyPaid  10 - Closed  11 - SecondReminderSent
     *
     * @return $this
     */
    public function setFactoringInvoiceStatus($factoring_invoice_status)
    {
        $allowedValues = $this->getFactoringInvoiceStatusAllowableValues();
        if (!is_null($factoring_invoice_status) && !in_array($factoring_invoice_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'factoring_invoice_status', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['factoring_invoice_status'] = $factoring_invoice_status;
     ...
     * Sets payment_status
     *
     * @param int $payment_status 0 = Paid, 1 = Unpaid, 2 = Overdue
     *
     * @return $this
     */
     ...
     * Gets credited_by
     *
     * @return \Struqtur\VismaEAccounting\Model\CreditedByApi[]
     */
    public function getCreditedBy()
    {
        return $this->container['credited_by'];
    }

    /**
     * Sets credited_by
     *
     * @param \Struqtur\VismaEAccounting\Model\CreditedByApi[] $credited_by Credit customer invoices created based on the customer invoice  Only applicable when IsCreditInvoice is false
     *
     * @return $this
     */
    public function setCreditedBy($credited_by)
    {
        $this->container['credited_by'] = $credited_by;
