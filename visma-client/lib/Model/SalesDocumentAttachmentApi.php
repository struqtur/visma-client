...
class SalesDocumentAttachmentApi implements ModelInterface, ArrayAccess
{
     ...
     * Sets document_id
     *
     * @param string $document_id Sales document ID.
     *
     * @return $this
     */
     ...
     * Sets document_type
     *
     * @param int $document_type Sales document type:  CustomerInvoiceDraft = 1,  CustomerInvoice = 2,  Quote = 3,  Order = 4,  PurchaseOrder = 5,  QuoteDraft = 6
     *
     * @return $this
     */
     ...
     *
     * @param string $original_filename Attached file name.
     *
     * @return $this
     */
     ...
     * Sets document_size
     *
     * @param int $document_size Attached file size.
     *
     * @return $this
     */
     ...
     * Sets created_utc
     *
     * @param \DateTime $created_utc Attachment date (UTC).
     *
     * @return $this
     */
     ...
     * Sets created_by
     *
     * @param string $created_by Full name of user who attached the file.
     *
     * @return $this
     */
     ...
     * Sets thumbnail
     *
     * @param string $thumbnail It is an image thumbnail, for PDF's Thumbnail = NULL.
     *
     * @return $this
     */
