...
/**
 * CustomerLedgerItemWithVoucherApi Class Doc Comment
 *
 * @category Class
 * @package  Struqtur\VismaEAccounting
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerLedgerItemWithVoucherApi implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomerLedgerItemWithVoucherApi';
    ...
    protected static $swaggerTypes = [
        ...
        'voucher' => '\Struqtur\VismaEAccounting\Model\VoucherApi',
    ...
    public function setCurrencyCode($currency_code)
    {
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CustomerLedgerItemWithVoucherApi., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CustomerLedgerItemWithVoucherApi., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $payment_reference_number Empty if UsesPaymentReferenceNumber not activated on the company. Use /v2/companysettings.
     *
     * @return $this
     */
    public function setPaymentReferenceNumber($payment_reference_number)
    {
        if (!is_null($payment_reference_number) && (mb_strlen($payment_reference_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $payment_reference_number when calling CustomerLedgerItemWithVoucherApi., must be smaller than or equal to 50.');
        }
        if (!is_null($payment_reference_number) && (mb_strlen($payment_reference_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_reference_number when calling CustomerLedgerItemWithVoucherApi., must be bigger than or equal to 0.');
        }
    ...
    public function setRemainingAmountInvoiceCurrency($remaining_amount_invoice_currency)
    {
        ...
        if (($remaining_amount_invoice_currency > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $remaining_amount_invoice_currency when calling CustomerLedgerItemWithVoucherApi., must be smaller than or equal to 1000000000.');
        }
        if (($remaining_amount_invoice_currency < -1000000000)) {
            throw new \InvalidArgumentException('invalid value for $remaining_amount_invoice_currency when calling CustomerLedgerItemWithVoucherApi., must be bigger than or equal to -1000000000.');
        }
    ...
    public function setRoundingsAmountInvoiceCurrency($roundings_amount_invoice_currency)
    {
        ...
        if (($roundings_amount_invoice_currency > 1)) {
            throw new \InvalidArgumentException('invalid value for $roundings_amount_invoice_currency when calling CustomerLedgerItemWithVoucherApi., must be smaller than or equal to 1.');
        }
        if (($roundings_amount_invoice_currency < -1)) {
            throw new \InvalidArgumentException('invalid value for $roundings_amount_invoice_currency when calling CustomerLedgerItemWithVoucherApi., must be bigger than or equal to -1.');
        }
    ...
    public function setTotalAmountInvoiceCurrency($total_amount_invoice_currency)
    {
        ...
        if (($total_amount_invoice_currency > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $total_amount_invoice_currency when calling CustomerLedgerItemWithVoucherApi., must be smaller than or equal to 1000000000.');
        }
        if (($total_amount_invoice_currency < -1000000000)) {
            throw new \InvalidArgumentException('invalid value for $total_amount_invoice_currency when calling CustomerLedgerItemWithVoucherApi., must be bigger than or equal to -1000000000.');
        }
    ...
    public function setVatAmountInvoiceCurrency($vat_amount_invoice_currency)
    {
        ...
        if (($vat_amount_invoice_currency > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $vat_amount_invoice_currency when calling CustomerLedgerItemWithVoucherApi., must be smaller than or equal to 1000000000.');
        }
        if (($vat_amount_invoice_currency < -1000000000)) {
            throw new \InvalidArgumentException('invalid value for $vat_amount_invoice_currency when calling CustomerLedgerItemWithVoucherApi., must be bigger than or equal to -1000000000.');
        }
     ...
     * Sets voucher
     *
     * @param \Struqtur\VismaEAccounting\Model\VoucherApi $voucher voucher
     *
     * @return $this
     */
