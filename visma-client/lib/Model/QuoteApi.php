...
class QuoteApi implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['company_reference']) && (mb_strlen($this->container['company_reference']) > 100)) {
            $invalidProperties[] = "invalid value for 'company_reference', the character length must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['company_reference']) && (mb_strlen($this->container['company_reference']) < 0)) {
            $invalidProperties[] = "invalid value for 'company_reference', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets modified_utc
     *
     * @param \DateTime $modified_utc Date and time of the last document modification.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param int $status 0 = Draft, 1 = Ongoing, 2 = Approved, 3 = Invoiced, 4 = OrderCreated
     *
     * @return $this
     */
     ...
     *
     * @param string $company_reference Equivalent for property OurReference in OrderApi and CustomerInvoiceApi models.
     *
     * @return $this
     */
    public function setCompanyReference($company_reference)
    {
        if (!is_null($company_reference) && (mb_strlen($company_reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $company_reference when calling QuoteApi., must be smaller than or equal to 100.');
        }
        if (!is_null($company_reference) && (mb_strlen($company_reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company_reference when calling QuoteApi., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $customer_reference Equivalent for property YourReference in OrderApi and CustomerInvoiceApi models.
     *
     * @return $this
     */
    public function setCustomerReference($customer_reference)
    {
        if (!is_null($customer_reference) && (mb_strlen($customer_reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $customer_reference when calling QuoteApi., must be smaller than or equal to 100.');
        }
        if (!is_null($customer_reference) && (mb_strlen($customer_reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customer_reference when calling QuoteApi., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $buyers_order_reference buyers_order_reference
     *
     * @return $this
     */
    public function setBuyersOrderReference($buyers_order_reference)
    {
        if (!is_null($buyers_order_reference) && (mb_strlen($buyers_order_reference) > 35)) {
            throw new \InvalidArgumentException('invalid length for $buyers_order_reference when calling QuoteApi., must be smaller than or equal to 35.');
        }
        if (!is_null($buyers_order_reference) && (mb_strlen($buyers_order_reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $buyers_order_reference when calling QuoteApi., must be bigger than or equal to 0.');
        }
     ...
     * Sets includes_vat
     *
     * @param bool $includes_vat Returns true if Amount and UnitPrice includes VAT. It will be automatically added based on company settings and customer type(private person or company).
     *
     * @return $this
     */
     ...
     *
     * @param string $customer_number Readonly  The selected customer's number
     *
     * @return $this
     */
     ...
     * Sets customer_name
     *
     * @param string $customer_name Readonly  The selected customer's name
     *
     * @return $this
     */
