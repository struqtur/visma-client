...
class NoteApi implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['document_type']) && ($this->container['document_type'] > 21)) {
    ...
    public function setDocumentType($document_type)
    {
        ...
        if (!is_null($document_type) && ($document_type > 21)) {
            throw new \InvalidArgumentException('invalid value for $document_type when calling NoteApi., must be smaller than or equal to 21.');
        }
