...
class InvoicePaymentApi implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['payment_type'] > 4)) {
            $invalidProperties[] = "invalid value for 'payment_type', must be smaller than or equal to 4.";
        }
     ...
     * Sets payment_type
     *
     * @param int $payment_type 1 = PartialPayment  2 = CompletePayment  3 = Rounding: The payment amount must be rounded on the customer side and the payment of the invoice will be recorded as fully paid.  The difference between entered amount and the total amount will count as rounding.  4 = Bank Charge
     *
     * @return $this
     */
    public function setPaymentType($payment_type)
    {
        ...
        if (($payment_type > 4)) {
            throw new \InvalidArgumentException('invalid value for $payment_type when calling InvoicePaymentApi., must be smaller than or equal to 4.');
        }
        if (($payment_type < 1)) {
