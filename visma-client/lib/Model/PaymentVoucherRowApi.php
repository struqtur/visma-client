...
/**
 * PaymentVoucherRowApi Class Doc Comment
 *
 * @category Class
 * @package  Struqtur\VismaEAccounting
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaymentVoucherRowApi implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentVoucherRowApi';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['receivable_id'] = isset($data['receivable_id']) ? $data['receivable_id'] : null;
        $this->container['payable_id'] = isset($data['payable_id']) ? $data['payable_id'] : null;
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if (($account_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_number when calling PaymentVoucherRowApi., must be bigger than or equal to 1.');
        }
    ...
    public function setDebitAmount($debit_amount)
    {
        ...
        if (!is_null($debit_amount) && ($debit_amount > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $debit_amount when calling PaymentVoucherRowApi., must be smaller than or equal to 1000000000.');
        }
        if (!is_null($debit_amount) && ($debit_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $debit_amount when calling PaymentVoucherRowApi., must be bigger than or equal to 0.');
        }
    ...
    public function setCreditAmount($credit_amount)
    {
        ...
        if (!is_null($credit_amount) && ($credit_amount > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $credit_amount when calling PaymentVoucherRowApi., must be smaller than or equal to 1000000000.');
        }
        if (!is_null($credit_amount) && ($credit_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $credit_amount when calling PaymentVoucherRowApi., must be bigger than or equal to 0.');
        }
    ...
    public function setTransactionText($transaction_text)
    {
        if (!is_null($transaction_text) && (mb_strlen($transaction_text) > 50)) {
            throw new \InvalidArgumentException('invalid length for $transaction_text when calling PaymentVoucherRowApi., must be smaller than or equal to 50.');
        }
        if (!is_null($transaction_text) && (mb_strlen($transaction_text) < 0)) {
            throw new \InvalidArgumentException('invalid length for $transaction_text when calling PaymentVoucherRowApi., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['receivable_id'];
    }

    /**
     * Sets receivable_id
     *
     * @param string $receivable_id Purpose: Id of the customer invoice to be paid
     *
     * @return $this
     */
    public function setReceivableId($receivable_id)
    {
        $this->container['receivable_id'] = $receivable_id;
    ...
    {
        return $this->container['payable_id'];
    }

    /**
     * Sets payable_id
     *
     * @param string $payable_id Purpose: Id of the supplier invoice to be paid
     *
     * @return $this
     */
    public function setPayableId($payable_id)
    {
        $this->container['payable_id'] = $payable_id;
