...
class CustomerInvoiceDraftsV2Api
{
     ...
     * @param  bool $override_customer_is_private_person Set to true in order to override the CustomerIsPrivatePerson property in order to ignore the customer setting. (optional)
     *
     * @throws \Struqtur\VismaEAccounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Struqtur\VismaEAccounting\Model\CustomerInvoiceDraftApi
     */
    public function customerInvoiceDraftsV2Post($customer_invoice_draft, $override_customer_is_private_person = null)
    {
        list($response) = $this->customerInvoiceDraftsV2PostWithHttpInfo($customer_invoice_draft, $override_customer_is_private_person);
        return $response;
    }
     ...
     * @return array of \Struqtur\VismaEAccounting\Model\CustomerInvoiceDraftApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerInvoiceDraftsV2PostWithHttpInfo($customer_invoice_draft, $override_customer_is_private_person = null)
    {
        $returnType = '\Struqtur\VismaEAccounting\Model\CustomerInvoiceDraftApi';
        $request = $this->customerInvoiceDraftsV2PostRequest($customer_invoice_draft, $override_customer_is_private_person);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerInvoiceDraftsV2PostAsync($customer_invoice_draft, $override_customer_is_private_person = null)
    {
        return $this->customerInvoiceDraftsV2PostAsyncWithHttpInfo($customer_invoice_draft, $override_customer_is_private_person)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerInvoiceDraftsV2PostAsyncWithHttpInfo($customer_invoice_draft, $override_customer_is_private_person = null)
    {
        $returnType = '\Struqtur\VismaEAccounting\Model\CustomerInvoiceDraftApi';
        $request = $this->customerInvoiceDraftsV2PostRequest($customer_invoice_draft, $override_customer_is_private_person);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function customerInvoiceDraftsV2PostRequest($customer_invoice_draft, $override_customer_is_private_person = null)
    {
        ...
        // query params
        if ($override_customer_is_private_person !== null) {
            $queryParams['overrideCustomerIsPrivatePerson'] = ObjectSerializer::toQueryValue($override_customer_is_private_person);
        }
