...
class SupplierInvoiceDraftsV2Api
{
    ...
    /**
     * Operation supplierInvoiceDraftsV2DeleteAllocations
     *
     ...
     * @return object
     */
    public function supplierInvoiceDraftsV2DeleteAllocations($supplier_invoice_draft_id)
    {
        list($response) = $this->supplierInvoiceDraftsV2DeleteAllocationsWithHttpInfo($supplier_invoice_draft_id);
        return $response;
    }

    /**
     * Operation supplierInvoiceDraftsV2DeleteAllocationsWithHttpInfo
     *
     * Deletes allocationperiods connected to supplier invoice draft
     *
     * @param  string $supplier_invoice_draft_id  (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function supplierInvoiceDraftsV2DeleteAllocationsWithHttpInfo($supplier_invoice_draft_id)
    {
        $returnType = 'object';
        $request = $this->supplierInvoiceDraftsV2DeleteAllocationsRequest($supplier_invoice_draft_id);
    ...
    /**
     * Operation supplierInvoiceDraftsV2DeleteAllocationsAsync
     *
     * Deletes allocationperiods connected to supplier invoice draft
     *
     * @param  string $supplier_invoice_draft_id  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function supplierInvoiceDraftsV2DeleteAllocationsAsync($supplier_invoice_draft_id)
    {
        return $this->supplierInvoiceDraftsV2DeleteAllocationsAsyncWithHttpInfo($supplier_invoice_draft_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation supplierInvoiceDraftsV2DeleteAllocationsAsyncWithHttpInfo
     *
     * Deletes allocationperiods connected to supplier invoice draft
     *
     * @param  string $supplier_invoice_draft_id  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function supplierInvoiceDraftsV2DeleteAllocationsAsyncWithHttpInfo($supplier_invoice_draft_id)
    {
        $returnType = 'object';
        $request = $this->supplierInvoiceDraftsV2DeleteAllocationsRequest($supplier_invoice_draft_id);
    ...
    /**
     * Create request for operation 'supplierInvoiceDraftsV2DeleteAllocations'
     *
     * @param  string $supplier_invoice_draft_id  (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function supplierInvoiceDraftsV2DeleteAllocationsRequest($supplier_invoice_draft_id)
    {
        // verify the required parameter 'supplier_invoice_draft_id' is set
        if ($supplier_invoice_draft_id === null || (is_array($supplier_invoice_draft_id) && count($supplier_invoice_draft_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $supplier_invoice_draft_id when calling supplierInvoiceDraftsV2DeleteAllocations'
            );
        }

        $resourcePath = '/v2/supplierinvoicedrafts/{supplierInvoiceDraftId}/allocationperiods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
