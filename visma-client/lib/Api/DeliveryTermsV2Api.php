...
class DeliveryTermsV2Api
{
     ...
     * @return \Struqtur\VismaEAccounting\Model\PaginatedResponseDeliveryTermApi
     */
     ...
     * @throws \Struqtur\VismaEAccounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Struqtur\VismaEAccounting\Model\PaginatedResponseDeliveryTermApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function deliveryTermsV2GetWithHttpInfo()
    {
        $returnType = '\Struqtur\VismaEAccounting\Model\PaginatedResponseDeliveryTermApi';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Struqtur\VismaEAccounting\Model\PaginatedResponseDeliveryTermApi',
     ...
     * @throws \Struqtur\VismaEAccounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Struqtur\VismaEAccounting\Model\DeliveryTermApi
     */
     ...
     * @throws \Struqtur\VismaEAccounting\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Struqtur\VismaEAccounting\Model\DeliveryTermApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function deliveryTermsV2Get_0WithHttpInfo($delivery_term_id)
    {
        $returnType = '\Struqtur\VismaEAccounting\Model\DeliveryTermApi';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Struqtur\VismaEAccounting\Model\DeliveryTermApi',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
